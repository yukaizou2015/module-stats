...
# Timestamp: 2020-02-26 05:22:39 UTC
# 
...
RUN bash -c 'source activate repronim && jupyter nbextension enable exercise2/main && jupyter nbextension enable spellchecker/main'
