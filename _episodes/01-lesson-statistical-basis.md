...
sample the population of not taxi drivers, measure the hippocampi in the two
groups 2) assume that the two groups are in fact drawn in one homogeneous
...
is less than 5%.  See our lesson on p-values and caveats further.
